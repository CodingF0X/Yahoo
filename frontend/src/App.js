      ...
      <BrowserRouter> 
        <ThemeProvider theme={theme}>
          ...
          <Routes>
            ...
            <Route  path='/profile/:userId/settings/edit' element={user ? <EditProfile /> : <Navigate to='/'/> } />
            <Route  path='/profile/:userId/settings/edit/name_email' element={user ? <EditProfile /> : <Navigate to='/'/> } />
            <Route  path='/profile/:userId/settings/edit/password' element={user ? <EditProfile /> : <Navigate to='/'/> } />
